...
define i32 @main() #0 {
  ...
  %7 = add nsw i32 %5, 1
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 %7)
...
; <label>:16:                                     ; preds = %15, %14
  %.0 = phi i32* [ %2, %14 ], [ %12, %15 ]
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32* %.0)
